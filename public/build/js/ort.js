...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/ort.js");
/******/ })
/************************************************************************/
/******/ ({
...
searchOrt = function searchOrt(inputVal) {
    $.ajax({
        url: '/orte/find',
        type: 'post',
        data: {
        ...
        success: function success(data) {
            ...
            if (data != '[]') {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    td.insertAdjacentHTML('beforeend', '<button class="btn upd" id="myBtn" onclick="display(\'/orte/edit/' + id + '\')">Edit</button>');
                    td.insertAdjacentHTML('beforeend', '<button class="btn del" id="myBtn" onclick="delOrt(' + id + ')">Delete</button>');
                }
