...
$(document).ready(function () {
    ...
    /*Delete*/
    delOrt = function delOrt(url, id, toDel) {
        $.ajax({ url: url,
            type: 'post',
            data: {
                "id": id
