...
getContactsForCompany = function getContactsForCompany(company_field) {
    ...
    $.ajax({
        ...
        success: function success(output) {
            $.each(output, function (key, value) {
                $('#timetracker_contact_id').append($('<option>', { value: key }).text(value));
            });
        }
    });
};

hashAdd = function hashAdd(url) {
